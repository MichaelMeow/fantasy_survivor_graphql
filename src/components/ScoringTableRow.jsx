...
import { GET_TRIBES, GET_POINTSES } from './../constants/queries';
...
function ScoringTableRow({contestant, out, currentEpisode}) {
  ...
  return (
    <Query query={GET_POINTSES} variables={{contestant:contestant.id, episode:currentEpisode.id}}>
      {({ loading, error, data }) => {
